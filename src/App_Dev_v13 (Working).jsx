...
The door is about to open. It always does.`);
  ...
  const engineerPrompts = async () => {
    ...
    startProgress();
    try {
      const systemPrompt = `You are a visual director. Generate visual prompts based on the script word count. The number of visual prompts depends on how long the script is. There should be about an average of 5 to 6 scenes per 120 words. But, there should be NO LESS than 80 scenes. Visual Prompts should be spread almost evenly throughout the script.
      
      CRITICAL INSTRUCTION: You MUST output ONLY the scenes. Do not include any conversational text. Start directly with "1.".
      DO NOT be lazy. You MUST output the full text, including all boilerplate paragraphs, for ALL scenes.
